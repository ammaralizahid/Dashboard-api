...
export declare type RealTimeCallApiEventsHandlerMapping = Record<CallReceived, (call: Call) => void> & Record<CallState, (call: Call) => void> & Record<CallPlaybackStarted | CallPlaybackUpdated | CallPlaybackEnded | CallPlaybackFailed, (playback: CallPlayback) => void> & Record<CallRecordingStarted | CallRecordingUpdated | CallRecordingEnded | CallRecordingFailed, (recording: CallRecording) => void> & Record<CallPromptStarted | CallPromptUpdated | CallPromptEnded | CallPromptFailed, (prompt: CallPrompt) => void> & Record<CallTapStarted | CallTapEnded, (tap: CallTap) => void> & Record<CallCollectStarted | CallCollectStartOfInput | CallCollectUpdated | CallCollectEnded | CallCollectFailed, (callCollect: CallCollect) => void>;
export declare type RealTimeCallApiEvents = {
