import { BaseComponentOptions, VoiceCallPromptContract, CallingCallCollectResult, BaseComponent } from '@signalwire/core';
/**
...
export declare type CallPromptEventsHandlerMapping = {};
export interface CallPromptOptions extends BaseComponentOptions<CallPromptEventsHandlerMapping> {
}
export declare class CallPromptAPI extends BaseComponent<CallPromptEventsHandlerMapping> implements VoiceCallPromptContract {
...
export declare const createCallPromptObject: (params: CallPromptOptions) => CallPrompt;
