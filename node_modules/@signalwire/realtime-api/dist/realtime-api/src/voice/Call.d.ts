import { BaseComponentOptions, EmitterContract, VoiceCallContract, VoiceCallDisconnectReason, VoicePlaylist, VoiceCallPlayAudioMethodParams, VoiceCallPlaySilenceMethodParams, VoiceCallPlayRingtoneMethodParams, VoiceCallPlayTTSMethodParams, VoiceCallRecordMethodParams, VoiceCallPromptMethodParams, VoiceCallPromptAudioMethodParams, VoiceCallPromptRingtoneMethodParams, VoiceCallPromptTTSMethodParams, VoiceCallCollectMethodParams, EventTransform, VoiceCallTapMethodParams, VoiceCallTapAudioMethodParams, CallingCallState, CallingCallConnectState, VoiceCallConnectMethodParams, VoiceCallConnectPhoneMethodParams, VoiceCallConnectSipMethodParams, VoiceCallDetectMethodParams, VoiceCallDetectMachineParams, VoiceCallDetectFaxParams, VoiceCallDetectDigitParams, VoiceDialerParams, CallingCallWaitForState } from '@signalwire/core';
...
declare type EmitterTransformsEvents = 'calling.playback.start' | 'calling.playback.started' | 'calling.playback.updated' | 'calling.playback.ended' | 'calling.playback.failed' | 'calling.recording.started' | 'calling.recording.updated' | 'calling.recording.ended' | 'calling.recording.failed' | 'calling.prompt.started' | 'calling.prompt.updated' | 'calling.prompt.ended' | 'calling.prompt.failed' | 'calling.tap.started' | 'calling.tap.ended' | 'calling.detect.started' | 'calling.detect.ended' | 'calling.collect.started' | 'calling.collect.updated' | 'calling.collect.ended' | 'calling.collect.failed' | 'calling.call.state' | 'calling.detect.updated' | 'calling.connect.connected';
/**
 ...
 */
export declare const callingCollectTriggerEvent: EmitterTransformsEvents;
export declare class CallConsumer extends AutoApplyTransformsConsumer<RealTimeCallApiEvents> {
     ...
     * ```
     */
    collect(params: VoiceCallCollectMethodParams): Promise<CallCollect>;
}
