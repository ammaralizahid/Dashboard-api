...
function* initSessionSaga({
  ...
  session.disconnect();
  yield (0, import_effects4.take)(sessionDisconnectedAction.type);
  yield (0, import_effects4.put)(pubSubChannel, sessionDisconnectedAction());
  pubSubTask.cancel();
...
var executeActionWorker = function* (options) {
  ...
  try {
    ...
    const response = yield (0, import_effects5.call)(session.execute, message);
...
var createPubSubChannel = () => (0, import_core3.multicastChannel)();
